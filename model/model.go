...
type Tx struct {
	...
	TxHash        string    `json:"tx_hash" gorm:"type:char(64);not null;unique_index:idx_tx_hash_protocol"`
	Protocol      Protocol  `json:"protocol" gorm:"not null;unique_index:idx_tx_hash_protocol;default:'bitcoincash'" sql:"type:ENUM('fiat', 'bitcoincash', 'wormhole')"`
